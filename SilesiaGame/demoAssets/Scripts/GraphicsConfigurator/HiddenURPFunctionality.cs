...
namespace GraphicsConfigurator.Core.URP
{
    internal static partial class URPFunctionality
    {
        ...
        private static readonly FieldInfo m_UpscalingFilterSelection = getFieldInfo("m_UpscalingFilter");
        ...
        internal static UpscalingFilterSelection upscalingFilterSelection(UniversalRenderPipelineAsset asset,  UpscalingFilterSelection selection)
        {
            m_UpscalingFilterSelection.SetValue(asset, selection);
            return (UpscalingFilterSelection)asset.upscalingFilter;
        }
